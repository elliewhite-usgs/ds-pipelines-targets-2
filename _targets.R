...
p1_targets_list <- list(
  ...
  tar_target(site_info_csv_1, nwis_site_info(fileout = "1_fetch/out/site_info_1.csv", site_data_filein = site_data_1), format = "file"), 
  tar_target(site_info_csv_2, nwis_site_info(fileout = "1_fetch/out/site_info_2.csv", site_data_filein = site_data_2), format = "file"),
  tar_target(site_info_csv_3, nwis_site_info(fileout = "1_fetch/out/site_info_3.csv", site_data_filein = site_data_3), format = "file"),
  tar_target(site_info_csv_4, nwis_site_info(fileout = "1_fetch/out/site_info_4.csv", site_data_filein = site_data_4), format = "file")
)
